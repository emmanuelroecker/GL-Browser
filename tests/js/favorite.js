...
describe('favoriteClass', function () {
	describe('init read save', function () {
		...
		it('load from file', function () {
			let favorite = new favoriteClass();
			favorite.load('./tests/userdata/favorites.json');
			assert.equal(10, favorite._favorites.length);
		});
		...
		it('save in a file', function () {
			...
			favorite.save('./tests/tmp/favorites.tmp.json');
			assert.equal(447, fs.statSync('./tests/tmp/favorites.tmp.json')['size']);
		});
	...
	describe('search', function () {
		...
		it('search', function () {
			let favorite = new favoriteClass('./tests/userdata/favorites.json');
